"""Test script v2 - uses preprocessed data for slice eval + raw nii for 3D eval."""
import os, sys, json
...
def main():
    ...
    test_ds = PreprocessedDataset(test_ids, PREPROC_DIR / "test", augment=False)
    ...
    for r in case_results:
        print(f"  {r['patient_id']}: PSNR={r['psnr']}, Dice={r['dice']}, IoU={r['iou']}")
